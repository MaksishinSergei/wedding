      ...
      <div className="container">
        <div className="processing__inner">
          ...
          <p className="processing__text">
            ...
            самозанятым Поляковым Сергеем Николаевичем (далее — Оператор).
            <br />
            ...
            доступность в сети интернет по сетевому адресу https://invite-me.ru.{" "}
            <br />
            ...
            Оператора invite.online@yandex.ru с пометкой «Актуализация
            персональных данных». <br />
            ...
            invite.online@yandex.ru с пометкой «Отзыв согласия на обработку
            персональных данных». <br />
